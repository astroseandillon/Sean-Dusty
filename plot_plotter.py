...
# x1, y1, z1 = np.loadtxt('oliv_nk_zspheres.dat', unpack=True)
# x2, y2, z2 = np.loadtxt('oliv_nk_yspheres.dat', unpack=True)
# x3, y3, z3 = np.loadtxt('oliv_nk_xspheres.dat', unpack=True)
...
# ax.plot(x1, y1, label='oliv z spheres')
# ax.plot(x2, y2, label='oliv y spheres')
# ax.plot(x3, y3, label='oliv x spheres')
